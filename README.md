...
Before getting started, get **hivemall-core-0.5.0-incubating** (or **hivemall-all-0.5.0-incubating**) as documented on [Hivemall installation guide](https://hivemall.incubator.apache.org/userguide/getting_started/installation.html).
